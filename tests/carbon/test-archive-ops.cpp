...
{
    std::set<jak_field_sid> haystack;
...
{
    std::set<jak_field_sid> all_str_ids;
    ...
    for (std::set<jak_field_sid>::iterator it = all_str_ids.begin(); it != all_str_ids.end(); it++) {
        jak_field_sid string_id = *it;
