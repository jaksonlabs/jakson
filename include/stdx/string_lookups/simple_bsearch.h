...
#ifndef NG5_SIMPLE_BESEARCH
#define NG5_SIMPLE_BESEARCH
 ...
 */
int string_hashtable_create_besearch(struct string_lookup* map, const struct allocator* alloc, size_t num_buckets,
