...
typedef void (*carbon_compressor_incremental_sort_function)(
    carbon_vec_t *entries, size_t idx_offset, size_t length, bool forward
);

typedef char const * (*carbon_compressor_incremental_vecent2str)(
    carbon_vec_t *entries, size_t idx
);

typedef enum carbon_compressor_incremental_prefix_type {
    carbon_compressor_incremental_prefix_type_none,
    carbon_compressor_incremental_prefix_type_incremental,
    carbon_compressor_incremental_prefix_type_table
} carbon_compressor_incremental_prefix_type_e;
...
} carbon_compressor_incremental_stringset_properties_t;

CARBON_EXPORT(carbon_compressor_incremental_stringset_properties_t)
