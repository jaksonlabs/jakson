#ifndef CARBON_COMPRESSOR_AUTO_H
#define CARBON_COMPRESSOR_AUTO_H
...
CARBON_EXPORT(bool)
carbon_compressor_auto_print_extra(carbon_compressor_t *self, FILE *file, carbon_memfile_t *src, size_t nbytes);
...
CARBON_EXPORT(bool)
carbon_compressor_auto_print_encoded_string(carbon_compressor_t *self, FILE *file, carbon_memfile_t *src,
